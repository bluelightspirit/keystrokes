...
## Cloning this repository, opening the project through the .sln file, then running Program.cs has worked when bluelightspirit tested this on an external computer.
